<html class="loaded" lang="en" data-textdirection="ltr" style="--vh:4.38px;"><!-- BEGIN: Head--><head>
  ...
  <!-- BEGIN: Body-->
  <body class="horizontal-layout horizontal-menu 2-columns menu-expanded pace-done" data-open="hover" data-menu="horizontal-menu" data-col="2-columns" cz-shortcut-listen="true"><div class="pace  pace-inactive"><div class="pace-progress" data-progress-text="100%" data-progress="99" style="transform: translate3d(100%, 0px, 0px);">
  <div class="pace-progress-inner"></div>
</div>
<div class="pace-activity"></div></div>

    <!-- BEGIN: Header-->
    <nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-static-top navbar-dark bg-gradient-x-grey-blue navbar-border navbar-brand-center" data-nav="brand-center">
              ...
              <li class="dropdown nav-item mega-dropdown d-none d-lg-block"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">Mega</a>
                <ul class="mega-dropdown-menu dropdown-menu row p-1">
                  ...
                  <li class="col-md-5 px-2">
                    ...
                    <ul class="row mt-2">
                      <li class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3" href="email.html" target="_blank"><i class="feather icon-mail font-large-1 mr-0"></i>
                          <p class="font-medium-2 mt-25 mb-0">Email</p></a></li>
                      <li class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3" href="chat.html" target="_blank"><i class="feather icon-message-square font-large-1 mr-0"></i>
                          <p class="font-medium-2 mt-25 mb-0">Chat</p></a></li>
                      <li class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3 mt-75 mt-xl-0" href="todo.html" target="_blank"><i class="feather icon-check-square font-large-1 mr-0"></i>
                          <p class="font-medium-2 mt-25 mb-0">Todo</p></a></li>
                      <li class="col-6 col-xl-4"><a class="text-center mb-2 mt-75 mt-xl-0" href="kanban.html" target="_blank"><i class="feather icon-file-plus font-large-1 mr-0"></i>
                          <p class="font-medium-2 mt-25 mb-50">Kanban</p></a></li>
                      <li class="col-6 col-xl-4"><a class="text-center mb-2 mt-75 mt-xl-0" href="contacts.html" target="_blank"><i class="feather icon-users font-large-1 mr-0"></i>
    ...
    <!-- BEGIN: Main Menu-->
    <div id="sticky-wrapper" class="sticky-wrapper" style="height: 56px;"><div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-light navbar-without-dd-arrow navbar-shadow menu-border navbar-brand-center" role="navigation" data-menu="menu-wrapper" data-nav="brand-center" style="width: 1519.2px;">
      ...
      <div class="navbar-container main-menu-content" data-menu="menu-container">
        ...
        <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="feather icon-box"></i><span data-i18n="Apps">Apps</span></a>
            <ul class="dropdown-menu">
              <li data-menu=""><a class="dropdown-item" href="email.html" data-i18n="Email Application" data-toggle="dropdown">Email Application</a>
              </li>
              <li data-menu=""><a class="dropdown-item" href="chat.html" data-i18n="Chat Application" data-toggle="dropdown">Chat Application</a>
              </li>
              <li data-menu=""><a class="dropdown-item" href="todo.html" data-i18n="Todo Application" data-toggle="dropdown">Todo Application</a>
              </li>
              <li data-menu=""><a class="dropdown-item" href="kanban.html" data-i18n="Kanban Application" data-toggle="dropdown">Kanban Application</a>
              </li>
              <li data-menu=""><a class="dropdown-item" href="contacts.html" data-i18n="Contacts" data-toggle="dropdown">Contacts</a>
              </li>
	...
	<div class="tab-content px-1 pt-1">
		...
		<div class="tab-pane" id="tabIcon22-base" aria-labelledby="baseIcon-tab22-base">
				...
				<div class="custom-control custom-checkbox mb-1" style="display: none !important">
	...
	<ul class="nav nav-tabs nav-underline nav-justified color-options">
		<li class="nav-item" style="display: none !important">
			<a class="nav-link nav-semi-light" id="color-opt-1" data-toggle="tab" aria-controls="clrOpt1" href="#clrOpt1" aria-expanded="false">Semi Light</a>
		</li>
		<li class="nav-item" style="display: none !important">
		...
		<li class="nav-item">
			<a class="nav-link nav-light active" id="color-opt-4" data-toggle="tab" aria-controls="clrOpt4" href="#clrOpt4" aria-expanded="true">Light</a>
		</li>
	</ul>
	<div class="tab-content px-1 pt-1">
		<div role="tabpanel" class="tab-pane" id="clrOpt1" aria-expanded="true" aria-labelledby="color-opt-1">
			<div class="row">
				<div class="col-6">
					<h6>Solid</h6>
		...
		<div class="tab-pane active" id="clrOpt4" aria-labelledby="color-opt-4">
...
<div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 731px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 640px;"></div></div></div>
    </div>
    <!-- End: Customizer-->
    ...
    <footer class="footer footer-static footer-light navbar-shadow">
      <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span class="float-md-left d-block d-md-inline-block">Copyright  © 2020 <a class="text-bold-800 grey darken-2" href="https://1.envato.market/pixinvent_portfolio" target="_blank">PIXINVENT 			</a></span><span class="float-md-right d-none d-lg-block">Hand-crafted &amp; Made with <i class="feather icon-heart pink"></i></span></p>
    </footer>
    <!-- END: Footer-->
